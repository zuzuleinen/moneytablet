...
<html lang="en">
    ...
    <body style="padding-top: 50px; padding-bottom: 20px;">
        ...
        <div class="container">
            ...
            @section('footer')
            <footer>
                <p>&copy; MoneyTablet.com {{date('Y')}}. This app was created by <a href="http://www.andreiboar.com/" target="_blank">Andrei Boar</a>. Feel free to <a href="mailto:andrey.boar@gmail.com" target="_blank">e-mail</a> me or <a href="https://github.com/zuzuleinen/moneytablet" target="_blank">contribute</a> to the project.</p>
            </footer>
            @show
        </div>
